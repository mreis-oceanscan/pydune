...
class LblBeaconExtended(Message):
	@property
	def beacon(self) -> str: ...
	@beacon.setter
	def beacon(self, beacon: str) -> None: ...
...
class Pulse(Message):
	@property
	def origin_timestamp(self) -> float: ...
	@origin_timestamp.setter
	def origin_timestamp(self, origin_timestamp: float) -> None: ...
...
class UamJanusPacket(Message):
	...
	@baseline_flags.setter
	def baseline_flags(self, baseline_flags: int) -> None: ...
	@property
	def time(self) -> float: ...
	@time.setter
	def time(self, time: float) -> None: ...
	@property
	def class_user_id(self) -> int: ...
	@class_user_id.setter
	def class_user_id(self, class_user_id: int) -> None: ...
	@property
	def application_type(self) -> int: ...
	@application_type.setter
	def application_type(self, application_type: int) -> None: ...
	@property
	def adb(self) -> bytes: ...
	@adb.setter
	def adb(self, adb: bytes) -> None: ...
	@property
	def error(self) -> str: ...
	@error.setter
	def error(self, error: str) -> None: ...
	...
	@property
	def cargo(self) -> bytes: ...
	@cargo.setter
	def cargo(self, cargo: bytes) -> None: ...
	class OperationEnum:
		SEND_REQ = 0
		BASELINE_RECV = 1
		UNPACK_REQ = 2
		...
		SEND_SUCCESS = 5
		SEND_ERROR = 6
	class BaselinePacketFlagsBits:
		MOBILE = 0x01
		REPEAT_INTERVAL = 0x02
		RESERVATION_TIME = 0x04
		DECODE_CAPABILITY = 0x08
		FORWARD_CAPABILITY = 0x16
...
class MessagePartControl(Message):
	@property
	def uid(self) -> int: ...
	@uid.setter
	def uid(self, uid: int) -> None: ...
	...
	def op(self, op: int) -> None: ...
	@property
	def frag_ids(self) -> str: ...
	@frag_ids.setter
	def frag_ids(self, frag_ids: str) -> None: ...
	class OperationEnum:
		STATUS_RECEIVED = 0
...
class ChargingState(Message):
	@property
	def is_charging(self) -> int: ...
	@is_charging.setter
	def is_charging(self, is_charging: int) -> None: ...
	class IsChargingEnum:
		NOT_CHARGING = 0
		IS_CHARGING = 1
...
class FileSampleEvent(Message):
	@property
	def fstype(self) -> int: ...
	@fstype.setter
	def fstype(self, fstype: int) -> None: ...
	@property
...
class QueryGsmCredit(Message):
	@property
	def req_id(self) -> int: ...
	@req_id.setter
	def req_id(self, req_id: int) -> None: ...

class FileClassification(Message):
	@property
	def original_filepath(self) -> str: ...
	@original_filepath.setter
	def original_filepath(self, original_filepath: str) -> None: ...
	@property
	def resized_filepath(self) -> str: ...
	@resized_filepath.setter
	def resized_filepath(self, resized_filepath: str) -> None: ...
	@property
	def class_prediction(self) -> str: ...
	@class_prediction.setter
	def class_prediction(self, class_prediction: str) -> None: ...
	@property
...
class IridiumMsgTxExtended(Message):
	@property
	def req_id(self) -> int: ...
	@req_id.setter
	def req_id(self, req_id: int) -> None: ...
...
class WifiStats(Message):
	...
	def ccq(self) -> int: ...
	@ccq.setter
	def ccq(self, ccq: int) -> None: ...
	@property
	def noise_floor(self) -> int: ...
	@noise_floor.setter
	def noise_floor(self, noise_floor: int) -> None: ...
	@property
	def signal(self) -> int: ...
	@signal.setter
	...
	@rx_rate.setter
	def rx_rate(self, rx_rate: int) -> None: ...
	@property
	def tx_rate(self) -> int: ...
	@tx_rate.setter
	def tx_rate(self, tx_rate: int) -> None: ...
	@property
	def tx_latency(self) -> int: ...
	@tx_latency.setter
	def tx_latency(self, tx_latency: int) -> None: ...
	@property
	...
	@rx_count.setter
	def rx_count(self, rx_count: int) -> None: ...
	@property
	def tx_count(self) -> int: ...
	@tx_count.setter
	def tx_count(self, tx_count: int) -> None: ...
	@property
	def distance(self) -> int: ...
	@distance.setter
	def distance(self, distance: int) -> None: ...

class WifiNetwork(Message):
	@property
	def essid(self) -> str: ...
	@essid.setter
	def essid(self, essid: str) -> None: ...
	@property
	def mac(self) -> str: ...
	@mac.setter
	def mac(self, mac: str) -> None: ...
...
class SonarPulse(Message):
	...
	@pulse_length.setter
	def pulse_length(self, pulse_length: int) -> None: ...
	@property
	def time_delay(self) -> int: ...
	@time_delay.setter
	def time_delay(self, time_delay: int) -> None: ...
	@property
	def simulated_speed(self) -> int: ...
	@simulated_speed.setter
	def simulated_speed(self, simulated_speed: int) -> None: ...
...
class ValuesIf(Message):
	...
	def value(self, value: str) -> None: ...
	@property
	def values_list(self) -> str: ...
	@values_list.setter
	def values_list(self, values_list: str) -> None: ...
...
class SatellitesInView(Message):
	@property
	def nsat(self) -> int: ...
	@nsat.setter
	def nsat(self, nsat: int) -> None: ...

class GnssHwMon(Message):
	@property
	def jamming_prob(self) -> int: ...
	@jamming_prob.setter
	def jamming_prob(self, jamming_prob: int) -> None: ...
	@property
	def jam_stat(self) -> int: ...
	@jam_stat.setter
	def jam_stat(self, jam_stat: int) -> None: ...
	@property
	def rf_noise(self) -> int: ...
	@rf_noise.setter
	def rf_noise(self, rf_noise: int) -> None: ...
	@property
	def ant_stat(self) -> int: ...
	@ant_stat.setter
	def ant_stat(self, ant_stat: int) -> None: ...
	@property
	def ant_pwr(self) -> int: ...
	@ant_pwr.setter
	def ant_pwr(self, ant_pwr: int) -> None: ...
	class JammingStatusEnum:
		UNKNOWN = 0
		OK = 1
		WAR = 2
		CRIT = 3
	class AntennaStatusEnum:
		INIT = 0
		UNKNOWN = 1
		OK = 2
		SHORT = 3
		OPEN = 4
	class AntennaPowerEnum:
		OFF = 0
		ON = 1
		UNKNOWN = 2

class PulseWidth(Message):
	@property
	def value(self) -> int: ...
	@value.setter
	def value(self, value: int) -> None: ...

class SpecificConductance(Message):
	@property
	def value(self) -> float: ...
	@value.setter
	def value(self, value: float) -> None: ...

class Ammonia(Message):
	@property
	def value(self) -> float: ...
	@value.setter
	def value(self, value: float) -> None: ...

class Ammonium(Message):
	@property
	def value(self) -> float: ...
	@value.setter
	def value(self, value: float) -> None: ...

class Nitrate(Message):
	@property
	def value(self) -> float: ...
	@value.setter
	def value(self, value: float) -> None: ...

class NitrateN(Message):
	@property
	def value(self) -> float: ...
	@value.setter
	def value(self, value: float) -> None: ...

class Chloride(Message):
	@property
	def value(self) -> float: ...
	@value.setter
	def value(self, value: float) -> None: ...
...
class BDI(Message):
	...
	def soh(self) -> int: ...
	@soh.setter
	def soh(self, soh: int) -> None: ...
	@property
	def is_fd(self) -> int: ...
	@is_fd.setter
	def is_fd(self, is_fd: int) -> None: ...
	@property
	def is_fc(self) -> int: ...
	@is_fc.setter
	def is_fc(self, is_fc: int) -> None: ...
	@property
	def rest(self) -> int: ...
	@rest.setter
	def rest(self, rest: int) -> None: ...
	@property
	def vdq(self) -> int: ...
	@vdq.setter
	def vdq(self, vdq: int) -> None: ...
	@property
	def cycle_count(self) -> int: ...
	@cycle_count.setter
	def cycle_count(self, cycle_count: int) -> None: ...
	@property
	def full_capacity(self) -> int: ...
	@full_capacity.setter
	def full_capacity(self, full_capacity: int) -> None: ...
	@property
	def rem_capacity(self) -> int: ...
	@rem_capacity.setter
	def rem_capacity(self, rem_capacity: int) -> None: ...
	class IsFullyDischargedEnum:
		NOT_FULLY_DISCHARGED = 0
		FULLY_DISCHARGED = 1
		UNKNOWN = 2
	class IsFullyChargedEnum:
		NOT_FULLY_CHARGED = 0
		FULLY_CHARGED = 1
		UNKNOWN = 2
	class RestEnum:
...
class MagneticCalibrationQuery(Message):
	pass

class MagneticCalibration(Message):
	@property
	def utc_time(self) -> float: ...
	@utc_time.setter
	def utc_time(self, utc_time: float) -> None: ...
	...
	def height(self, height: float) -> None: ...
	@property
	def hard_x(self) -> float: ...
	@hard_x.setter
	def hard_x(self, hard_x: float) -> None: ...
	@property
	def hard_y(self) -> float: ...
	@hard_y.setter
	def hard_y(self, hard_y: float) -> None: ...
	@property
	def hard_z(self) -> float: ...
	@hard_z.setter
	def hard_z(self, hard_z: float) -> None: ...
	@property
	def soft_xx(self) -> float: ...
	@soft_xx.setter
	def soft_xx(self, soft_xx: float) -> None: ...
	@property
	def soft_yy(self) -> float: ...
	@soft_yy.setter
	def soft_yy(self, soft_yy: float) -> None: ...
	@property
	def soft_zz(self) -> float: ...
	@soft_zz.setter
	def soft_zz(self, soft_zz: float) -> None: ...
	@property
	def soft_xy(self) -> float: ...
	@soft_xy.setter
	def soft_xy(self, soft_xy: float) -> None: ...
	@property
	def soft_xz(self) -> float: ...
	@soft_xz.setter
	def soft_xz(self, soft_xz: float) -> None: ...
	@property
	def soft_yz(self) -> float: ...
	@soft_yz.setter
	def soft_yz(self, soft_yz: float) -> None: ...
	@property
	def mag_strength(self) -> float: ...
	@mag_strength.setter
	def mag_strength(self, mag_strength: float) -> None: ...
...
class LblConfigExtended(Message):
	@property
	def op(self) -> int: ...
	@op.setter
	def op(self, op: int) -> None: ...
	@property
	def beacons(self) -> MessageList[LblBeaconExtended]: ...
	@beacons.setter
	def beacons(self, beacons: MessageList[LblBeaconExtended]) -> None: ...
	class OperationEnum:
		SET_CFG = 0
		GET_CFG = 1
		CUR_CFG = 2
...
class FollowCommandState(Message):
	@property
	def control_src(self) -> int: ...
	@control_src.setter
	def control_src(self, control_src: int) -> None: ...
	...
	@command.setter
	def command(self, command: Message) -> None: ...
	@property
	def state(self) -> int: ...
	@state.setter
	def state(self, state: int) -> None: ...
...
class TypedEntityParameter(Message):
	@property
	def name(self) -> str: ...
	@name.setter
	def name(self, name: str) -> None: ...
	...
	@property
	def list_min_size(self) -> int: ...
	@list_min_size.setter
	def list_min_size(self, list_min_size: int) -> None: ...
	@property
	def list_max_size(self) -> int: ...
	@list_max_size.setter
	def list_max_size(self, list_max_size: int) -> None: ...
	@property
	def values_if_list(self) -> MessageList[ValuesIf]: ...
	@values_if_list.setter
	def values_if_list(self, values_if_list: MessageList[ValuesIf]) -> None: ...
	@property
...
class QueryTypedEntityParameters(Message):
	@property
	def op(self) -> int: ...
	@op.setter
	def op(self, op: int) -> None: ...
	...
	def entity_name(self, entity_name: str) -> None: ...
	@property
	def parameters(self) -> MessageList[TypedEntityParameter]: ...
	@parameters.setter
	def parameters(self, parameters: MessageList[TypedEntityParameter]) -> None: ...
	class OperationEnum:
		REQUEST = 0
		REPLY = 1

class DirSonarData(Message):
	@property
	def pose(self) -> Message: ...
	@pose.setter
	def pose(self, pose: Message) -> None: ...
	@property
	def measurement(self) -> Message: ...
	@measurement.setter
	def measurement(self, measurement: Message) -> None: ...

class ManeuverResumed(Message):
	@property
	def man_id(self) -> str: ...
	@man_id.setter
	def man_id(self, man_id: str) -> None: ...
	@property
	def man_list(self) -> MessageList[Maneuver]: ...
	@man_list.setter
	def man_list(self, man_list: MessageList[Maneuver]) -> None: ...
